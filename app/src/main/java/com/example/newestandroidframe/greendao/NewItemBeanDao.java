...
/** 
 * DAO for table "NEW_ITEM_BEAN".
*/
public class NewItemBeanDao extends AbstractDao<NewItemBean, String> {

    public static final String TABLENAME = "NEW_ITEM_BEAN";

    /**
     * Properties of entity NewItemBean.<br/>
    ...
    public NewItemBeanDao(DaoConfig config) {
        super(config);
    }
    
    public NewItemBeanDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"NEW_ITEM_BEAN\" (" + //
        ...
        // Add Indexes
        db.execSQL("CREATE INDEX " + constraint + "IDX_NEW_ITEM_BEAN_NEWS_CHANNEL_NAME ON NEW_ITEM_BEAN" +
                " (\"NEWS_CHANNEL_NAME\" ASC);");
    }

    /** Drops the underlying database table. */
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"NEW_ITEM_BEAN\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, NewItemBean entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, NewItemBean entity) {
        stmt.clearBindings();
    ...
    @Override
    public NewItemBean readEntity(Cursor cursor, int offset) {
        NewItemBean entity = new NewItemBean( //
    ...
    @Override
    public void readEntity(Cursor cursor, NewItemBean entity, int offset) {
    ...
    @Override
    protected final String updateKeyAfterInsert(NewItemBean entity, long rowId) {
        return entity.getNewsChannelName();
    }
    
    @Override
    public String getKey(NewItemBean entity) {
        if(entity != null) {
            return entity.getNewsChannelName();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(NewItemBean entity) {
